...
public final class FragmentQrScannerBinding implements ViewBinding {
  ...
  private FragmentQrScannerBinding(@NonNull LinearLayout rootView, @NonNull Button buttonReturn,
  ...
  public static FragmentQrScannerBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentQrScannerBinding((LinearLayout) rootView, buttonReturn, chooseImageButton,
