...
public final class ContentAcceptedEventsBinding implements ViewBinding {
  @NonNull
  ...
  private ContentAcceptedEventsBinding(@NonNull LinearLayout rootView,
  ...
  @NonNull
  public static ContentAcceptedEventsBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ContentAcceptedEventsBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.content_accepted_events, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ContentAcceptedEventsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ContentAcceptedEventsBinding((LinearLayout) rootView, buttonDecline, buttonEnroll,
          eventName);
    }
