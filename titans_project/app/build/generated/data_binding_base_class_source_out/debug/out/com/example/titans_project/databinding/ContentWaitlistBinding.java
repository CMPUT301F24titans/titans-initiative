...
public final class ContentWaitlistBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public static ContentWaitlistBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ContentWaitlistBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.content_waitlist, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ContentWaitlistBinding bind(@NonNull View rootView) {
