...
public final class FragmentApplicationFormBinding implements ViewBinding {
  ...
  private FragmentApplicationFormBinding(@NonNull RelativeLayout rootView,
  ...
  @NonNull
  public static FragmentApplicationFormBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentApplicationFormBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_application_form, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentApplicationFormBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentApplicationFormBinding((RelativeLayout) rootView, buttonCreateProfile,
