...
public final class ActivityAcceptedEventsBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityAcceptedEventsBinding(@NonNull RelativeLayout rootView,
  ...
  @NonNull
  public static ActivityAcceptedEventsBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityAcceptedEventsBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_accepted_events, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityAcceptedEventsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityAcceptedEventsBinding((RelativeLayout) rootView, buttonReturn,
