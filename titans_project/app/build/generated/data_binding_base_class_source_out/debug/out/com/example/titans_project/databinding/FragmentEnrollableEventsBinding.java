...
public final class FragmentEnrollableEventsBinding implements ViewBinding {
  @NonNull
  ...
  private FragmentEnrollableEventsBinding(@NonNull RelativeLayout rootView,
  ...
  @NonNull
  public static FragmentEnrollableEventsBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentEnrollableEventsBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_enrollable_events, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentEnrollableEventsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentEnrollableEventsBinding((RelativeLayout) rootView, buttonReturn,
